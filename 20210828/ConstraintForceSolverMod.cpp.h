/**
   \file
   \brief Implementation of ConstraintForceSolverMod class
...
#ifndef UCNOID_BODY_CONSTRAINT_FORCE_SOLVER_MOD_CPP_H
#define UCNOID_BODY_CONSTRAINT_FORCE_SOLVER_MOD_CPP_H
...
namespace detail::constraint_force_solver_mod {
...
public:
    ...
    typedef ConstraintForceSolverMod::CollisionHandler CollisionHandler;
    ...
    ConstraintForceSolverModImpl(WorldBase& world);
    ~ConstraintForceSolverModImpl();
    ...
    void debugPutMatrix(const TMatrix& M, const char *name) {
        if(detail::constraint_force_solver_mod::CFS_DEBUG_VERBOSE) putMatrix(M, name);
    }

    template<class TVector>
    void debugPutVector(const TVector& M, const char *name) {
        if(detail::constraint_force_solver_mod::CFS_DEBUG_VERBOSE) putVector(M, name);
    }
...
/*
  #ifdef _MSC_VER
  const double CFSModImpl::PI   = 3.14159265358979323846;
  const double CFSModImpl::PI_2 = 1.57079632679489661923;
  #endif
*/

typedef ConstraintForceSolverModImpl CFSModImpl;

CFSModImpl::ConstraintForceSolverModImpl(WorldBase& world) :
#if UCNOID_NOT_SUPPORTED
    world(world),
...
#endif  // UCNOID_NOT_SUPPORTED
{
    ...
    defaultContactCullingDistance = detail::constraint_force_solver_mod::DEFAULT_CONTACT_CULLING_DISTANCE;
    defaultContactCullingDepth = detail::constraint_force_solver_mod::DEFAULT_CONTACT_CULLING_DEPTH;
    defaultCoefficientOfRestitution = 0.0;
    
    maxNumGaussSeidelIteration = detail::constraint_force_solver_mod::DEFAULT_MAX_NUM_GAUSS_SEIDEL_ITERATION;
    numGaussSeidelInitialIteration = detail::constraint_force_solver_mod::DEFAULT_NUM_GAUSS_SEIDEL_INITIAL_ITERATION;
    gaussSeidelErrorCriterion = detail::constraint_force_solver_mod::DEFAULT_GAUSS_SEIDEL_ERROR_CRITERION;
    contactCorrectionDepth = detail::constraint_force_solver_mod::DEFAULT_CONTACT_CORRECTION_DEPTH;
    contactCorrectionVelocityRatio = detail::constraint_force_solver_mod::DEFAULT_CONTACT_CORRECTION_VELOCITY_RATIO;
...
inline CFSModImpl::~ConstraintForceSolverModImpl()
{
    if(detail::constraint_force_solver_mod::CFS_DEBUG){
        os.close();
    }
}


inline void CFSModImpl::initBody(const DyBodyPtr& body, BodyData& bodyData)
{
...
inline void CFSModImpl::initWorldExtraJoints()
{
...
inline void CFSModImpl::initBodyExtraJoints(int bodyIndex)
{
...
inline void CFSModImpl::initExtraJointSub(ExtraJoint& extrajoint, int bodyIndex0, int bodyIndex1)
{
...
inline void CFSModImpl::init2Dconstraint(int bodyIndex)
{
    ...
    for(int i=0; i < 3; ++i){
        ...
        constraint.numFrictionVectors = 0;
        constraint.globalFrictionIndex = std::numeric_limits<int>::max();
        linkPair->globalYpositions[i] = (rootLink->R() * detail::constraint_force_solver_mod::local2dConstraintPoints[i] + rootLink->p()).y();
    }
...
inline void CFSModImpl::initialize(void)
{
    if(detail::constraint_force_solver_mod::CFS_DEBUG || detail::constraint_force_solver_mod::CFS_MCP_DEBUG){
        static int ntest = 0;
        os.close();
    ...
    if(detail::constraint_force_solver_mod::CFS_MCP_DEBUG){
...
#if UCNOID_NOT_SUPPORTED
void CFSModImpl::initializeContactMaterials()
{
    if(!orgMaterialTable){
...
CFSModImpl::ContactMaterialEx* CFSModImpl::createContactMaterialFromMaterialPair(int material1, int material2)
{
...
inline void CFSModImpl::clearExternalForces()
{
...
inline void CFSModImpl::solve()
{
    ...
    if(detail::constraint_force_solver_mod::CFS_PUT_NUM_CONTACT_POINTS){
    ...
    if(globalNumConstraintVectors > 0){
        ...
        if(detail::constraint_force_solver_mod::CFS_DEBUG_VERBOSE) putContactPoints();
        ...
        if(detail::constraint_force_solver_mod::SKIP_REDUNDANT_ACCEL_CALC){
        ...
        if(detail::constraint_force_solver_mod::CFS_DEBUG_VERBOSE){
...
#else
        if(!detail::constraint_force_solver_mod::USE_PREVIOUS_LCP_SOLUTION || constraintsSizeChanged){
            solution.setZero();
        }
        ...
        if(!isConverged){
            ...
            if(detail::constraint_force_solver_mod::CFS_DEBUG_LCPCHECK){
...
inline void CFSModImpl::setConstraintPoints()
{
#ifdef ENABLE_SIMULATION_PROFILING
    timer.begin();
#endif
...
#if UCNOID_NOT_SUPPORTED
void CFSModImpl::extractConstraintPoints(const CollisionPair& collisionPair)
{
    LinkPair* pLinkPair;
...
*/
bool CFSModImpl::setContactConstraintPoint(LinkPair& linkPair, const Collision& collision)
{
...
void CFSModImpl::setFrictionVectors(ConstraintPoint& contact)
{
    Vector3 u = Vector3::Zero();
    int minAxis = 0;
...
inline void CFSModImpl::setExtraJointConstraintPoints(const ExtraJointLinkPairPtr& linkPair)
{
    ConstraintPointArray& constraintPoints = linkPair->constraintPoints;
...
inline void CFSModImpl::set2dConstraintPoints(const Constrain2dLinkPairPtr& linkPair)
{
    ...
    for(int i=0; i < n; ++i){
        DyLink* link1 = linkPair->link[1];
        Vector3 point1 = link1->p() + link1->R() * detail::constraint_force_solver_mod::local2dConstraintPoints[i];
        ConstraintPoint& constraint = constraintPoints[i];
...
inline void CFSModImpl::putContactPoints()
{
    os << "Contact Points\n";
...
inline void CFSModImpl::solveImpactConstraints()
{
    if(detail::constraint_force_solver_mod::CFS_DEBUG){
        os << "Impacts !" << std::endl;
    }
...
inline void CFSModImpl::initMatrices()
{
    const int n = globalNumConstraintVectors;
    const int m = globalNumFrictionVectors;

    const int dimLCP = detail::constraint_force_solver_mod::usePivotingLCP ? (n + m + m) : (n + m);

    Mlcp.resize(dimLCP, dimLCP);
    b.resize(dimLCP);
    solution.resize(dimLCP);

    if(detail::constraint_force_solver_mod::usePivotingLCP){
...
inline void CFSModImpl::setAccelCalcSkipInformation()
{
...
inline void CFSModImpl::setDefaultAccelerationVector()
{
...
inline void CFSModImpl::setAccelerationMatrix()
{
    const int n = globalNumConstraintVectors;
    const int m = globalNumFrictionVectors;
    ...
    if(detail::constraint_force_solver_mod::ASSUME_SYMMETRIC_MATRIX){
        copySymmetricElementsOfAccelerationMatrix(Knn, Ktn, Knt, Ktt);
    }
}


inline void CFSModImpl::initABMForceElementsWithNoExtForce(BodyData& bodyData)
{
...
inline void CFSModImpl::calcABMForceElementsWithTestForce
(BodyData& bodyData, DyLink* linkToApplyForce, const Vector3& f, const Vector3& tau)
{
    std::vector<LinkData>& linksData = bodyData.linksData;
...
inline void CFSModImpl::calcAccelsABM(BodyData& bodyData, int constraintIndex)
{
    std::vector<LinkData>& linksData = bodyData.linksData;
    ...
    int skipCheckNumber = detail::constraint_force_solver_mod::ASSUME_SYMMETRIC_MATRIX ? constraintIndex : (std::numeric_limits<int>::max() - 1);
    int n = linksData.size();
    for(int linkIndex = 1; linkIndex < n; ++linkIndex){

        LinkData& linkData = linksData[linkIndex];

        if(!detail::constraint_force_solver_mod::SKIP_REDUNDANT_ACCEL_CALC || linkData.numberToCheckAccelCalcSkip <= skipCheckNumber){
...
inline void CFSModImpl::calcAccelsMM(BodyData& bodyData, int constraintIndex)
{
    std::vector<LinkData>& linksData = bodyData.linksData;
    ...
    const int skipCheckNumber = detail::constraint_force_solver_mod::ASSUME_SYMMETRIC_MATRIX ? constraintIndex : (std::numeric_limits<int>::max() - 1);
...
inline void CFSModImpl::extractRelAccelsOfConstraintPoints
(Eigen::Block<MatrixX>& Kxn, Eigen::Block<MatrixX>& Kxt, int testForceIndex, int constraintIndex)
{
    int maxConstraintIndexToExtract = detail::constraint_force_solver_mod::ASSUME_SYMMETRIC_MATRIX ? constraintIndex : globalNumConstraintVectors;
...
inline void CFSModImpl::extractRelAccelsFromLinkPairCase1
(Eigen::Block<MatrixX>& Kxn, Eigen::Block<MatrixX>& Kxt,
 LinkPair& linkPair, int testForceIndex, int maxConstraintIndexToExtract)
{
    ...
    for(size_t i=0; i < constraintPoints.size(); ++i){
        ...
        if(detail::constraint_force_solver_mod::ASSUME_SYMMETRIC_MATRIX && constraintIndex > maxConstraintIndexToExtract){
            break;
        }
...
inline void CFSModImpl::extractRelAccelsFromLinkPairCase2
(Eigen::Block<MatrixX>& Kxn, Eigen::Block<MatrixX>& Kxt,
 LinkPair& linkPair, int iTestForce, int iDefault, int testForceIndex, int maxConstraintIndexToExtract)
{
    ...
    for(size_t i=0; i < constraintPoints.size(); ++i){
        ...
        if(detail::constraint_force_solver_mod::CFS_DEBUG_VERBOSE_2){
...
inline void CFSModImpl::extractRelAccelsFromLinkPairCase3
...
inline void CFSModImpl::copySymmetricElementsOfAccelerationMatrix
(Eigen::Block<MatrixX>& Knn, Eigen::Block<MatrixX>& Ktn, Eigen::Block<MatrixX>& Knt, Eigen::Block<MatrixX>& Ktt)
{
...
inline void CFSModImpl::clearSingularPointConstraintsOfClosedLoopConnections()
{
...
inline void CFSModImpl::setConstantVectorAndMuBlock()
{
    ...
    for(size_t i=0; i < constrainedLinkPairs.size(); ++i){
        ...
        for(int j=0; j < numConstraintsInPair; ++j){
            ...
            if(linkPair.isNonContactConstraint){
                ...
                // contact constraint
                if(detail::constraint_force_solver_mod::ENABLE_CONTACT_DEPTH_CORRECTION){
                    double velOffset;
                ...
                for(int k=0; k < constraint.numFrictionVectors; ++k){
                    ...
                    if( !detail::constraint_force_solver_mod::IGNORE_CURRENT_VELOCITY_IN_STATIC_FRICTION || constraint.numFrictionVectors == 1){
...
inline void CFSModImpl::addConstraintForceToLinks()
{
...
inline void CFSModImpl::addConstraintForceToLink(LinkPair* linkPair, int ipair)
{
...
inline void CFSModImpl::solveMCPByProjectedGaussSeidel(const MatrixX& M, const VectorX& b, VectorX& x)
{
    static const int loopBlockSize = detail::constraint_force_solver_mod::DEFAULT_NUM_GAUSS_SEIDEL_ITERATION_BLOCK;
    ...
    while(i < numBlockLoops){
        ...
        if(true){
            double n = x.norm();
            if(n > detail::constraint_force_solver_mod::THRESH_TO_SWITCH_REL_ERROR){
            ...
            for(int j=0; j < x.size(); ++j){
                ...
                if(d > detail::constraint_force_solver_mod::THRESH_TO_SWITCH_REL_ERROR){
                    d /= x(j);
                }
                if(d > error){
                    error = d;
        ...
        if(error < gaussSeidelErrorCriterion){
            if(detail::constraint_force_solver_mod::CFS_MCP_DEBUG_SHOW_ITERATION_STOP){
...
inline void CFSModImpl::solveMCPByProjectedGaussSeidelMainStep(const MatrixX& M, const VectorX& b, VectorX& x)
{
    ...
    if(detail::constraint_force_solver_mod::ENABLE_TRUE_FRICTION_CONE){
        ...
        for(int j=globalNumConstraintVectors; j < size; ++j, ++frictionIndex){
            ...
            const double fmax = mcpHi[contactIndex];
            const double fmin = (detail::constraint_force_solver_mod::STATIC_FRICTION_BY_TWO_CONSTRAINTS ? -fmax : 0.0);
...
inline void CFSModImpl::solveMCPByProjectedGaussSeidelInitial
(const MatrixX& M, const VectorX& b, VectorX& x, const int numIteration)
{
    const int size = globalNumConstraintVectors + globalNumFrictionVectors;
...
inline void CFSModImpl::checkLCPResult(MatrixX& M, VectorX& b, VectorX& x)
{
    os << "check LCP result\n";
    os << "-------------------------------\n";
...
inline void CFSModImpl::checkMCPResult(MatrixX& M, VectorX& b, VectorX& x)
{
    os << "check MCP result\n";
    os << "-------------------------------\n";
...
#ifdef USE_PIVOTING_LCP
bool CFSModImpl::callPathLCPSolver(MatrixX& Mlcp, VectorX& b, VectorX& solution)
{
...
inline ConstraintForceSolverMod::ConstraintForceSolverMod(WorldBase& world)
{
    impl = new CFSModImpl(world);
}


inline ConstraintForceSolverMod::~ConstraintForceSolverMod()
{
    delete impl;
}

#if UCNOID_NOT_SUPPORTED
void ConstraintForceSolverMod::setCollisionDetector(CollisionDetector* detector)
{
    impl->bodyCollisionDetector.setCollisionDetector(detector);
}


CollisionDetector* ConstraintForceSolverMod::collisionDetector()
{
    return impl->bodyCollisionDetector.collisionDetector();
}


void ConstraintForceSolverMod::setMaterialTable(MaterialTable* table)
{
    impl->orgMaterialTable = table;
}

void ConstraintForceSolverMod::setFriction(double staticFriction, double slipFliction)
{
...
double ConstraintForceSolverMod::staticFriction() const
{
    return impl->defaultStaticFriction;
}


double ConstraintForceSolverMod::slipFriction() const
{
    return impl->defaultSlipFriction;
}

void ConstraintForceSolverMod::registerCollisionHandler(const std::string& name, CollisionHandler handler)
{
    CFSModImpl::CollisionHandlerInfoPtr info = new CFSModImpl::CollisionHandlerInfo;;
    info->handler = handler;
    impl->collisionHandlerMap[name] = info;
}


bool ConstraintForceSolverMod::unregisterCollisionHandler(const std::string& name)
{
    return (impl->collisionHandlerMap.erase(name) > 0);
}


void ConstraintForceSolverMod::setSelfCollisionDetectionEnabled(int bodyIndex, bool on)
{
...
bool ConstraintForceSolverMod::isSelfCollisionDetectionEnabled(int bodyIndex) const
{
    std::vector<bool>& isSCE = impl->isSelfCollisionDetectionEnabled;
    if(bodyIndex < isSCE.size()){
...
void ConstraintForceSolverMod::setContactCullingDistance(double distance)
{
    impl->defaultContactCullingDistance = distance;
}


double ConstraintForceSolverMod::contactCullingDistance() const
{
    return impl->defaultContactCullingDistance;
}


void ConstraintForceSolverMod::setContactCullingDepth(double depth)
{
    impl->defaultContactCullingDepth = depth;
}


double ConstraintForceSolverMod::contactCullingDepth()
{
    return impl->defaultContactCullingDepth;
}
#endif  // UCNOID_NOT_SUPPORTED

inline void ConstraintForceSolverMod::setCoefficientOfRestitution(double epsilon)
{
    impl->defaultCoefficientOfRestitution = epsilon;
}


inline double ConstraintForceSolverMod::coefficientOfRestitution() const
{
    return impl->defaultCoefficientOfRestitution;
}


inline void ConstraintForceSolverMod::setGaussSeidelErrorCriterion(double e)
{
    impl->gaussSeidelErrorCriterion = e;
}


inline double ConstraintForceSolverMod::gaussSeidelErrorCriterion()
{
    return impl->gaussSeidelErrorCriterion;
}


inline void ConstraintForceSolverMod::setGaussSeidelMaxNumIterations(int n)
{
    impl->maxNumGaussSeidelIteration = n;
}


inline int ConstraintForceSolverMod::gaussSeidelMaxNumIterations()
{
    return impl->maxNumGaussSeidelIteration;
}

#if UCNOID_NOT_SUPPORTED
void ConstraintForceSolverMod::setContactDepthCorrection(double depth, double velocityRatio)
{
...
double ConstraintForceSolverMod::contactCorrectionDepth()
{
    return impl->contactCorrectionDepth;
}


double ConstraintForceSolverMod::contactCorrectionVelocityRatio()
{
    return impl->contactCorrectionVelocityRatio;
}
#endif  // UCNOID_NOT_SUPPORTED

inline void ConstraintForceSolverMod::enableConstraintForceOutput(bool on)
{
    impl->isConstraintForceOutputMode = on;
}


inline void ConstraintForceSolverMod::set2Dmode(bool on)
{
    impl->is2Dmode = on;
}


inline void ConstraintForceSolverMod::initialize(void)
{
    impl->initialize();
}


inline void ConstraintForceSolverMod::solve()
{
    impl->solve();
}


inline void ConstraintForceSolverMod::clearExternalForces()
{
    impl->clearExternalForces();
}

#if UCNOID_NOT_SUPPORTED
CollisionLinkPairListPtr ConstraintForceSolverMod::getCollisions()
{
    return impl->getCollisions();
}


CollisionLinkPairListPtr CFSModImpl::getCollisions()
{
...
#ifdef ENABLE_SIMULATION_PROFILING
double ConstraintForceSolverMod::getCollisionTime()
{
...
#endif  // UCNOID_BODY_CONSTRAINT_FORCE_SOLVER_MOD_CPP_H
